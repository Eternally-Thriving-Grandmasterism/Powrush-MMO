 ...
 *
 * Features:
 * - Beautiful PATSAGi-aligned UI
 * - Motion Blur toggle + intensity +/- slider with live display
 * - Full integration with ClientSettings RON serialization
 * - TAA jitter scale support
 * - Apply / Close buttons properly save settings
 */
