 ...
 *
 * Full clean version with MusicLayerRegistry and AssetServer groundwork.
 *
 * v19.03 — Cleaned and consolidated.
 *
...
/// Activate layers using the registry for asset/caching management.
