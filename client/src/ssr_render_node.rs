/*!
 * TemporalSSRNode now binds velocity texture and enables velocity-based reprojection.
 */
...
// ... (other resources like TemporalSSRTextures, TemporalSSRPipeline, CameraMatrices remain)
...
impl Node for TemporalSSRNode {
    ...
    fn run(
        ...
        let velocity_tex = world.resource::<crate::velocity_prepass::VelocityTexture>(); // From velocity prepass
        ...
        for depth_texture in self.query.iter_manual(world) {
            let temporal_uniforms = TemporalUniforms {
                ...
                blend_factor: 0.83,
                use_velocity: 1, // Enable velocity-based reprojection
            };
...
// Note: Make sure VelocityTexture is inserted as a resource from velocity_prepass.rs
