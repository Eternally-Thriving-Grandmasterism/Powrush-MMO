/*!
 * Refined, polished Hanabi EffectAssets with better visual parameters.
 */
...
pub fn setup_policy_particle_effects(
    ...
    // === AbundanceBoost - Vibrant green upward energy burst ===
    ...
    // === SustainabilityFocus - Calm, flowing cyan/teal particles ===
    ...
    // === HarmonyStabilization - Soft, gentle pink spread ===
    let mut harmony = EffectAsset::new(
        380,
        Spawner::once(55.0.into(), true),
        Module::default(),
    );
    harmony
    ...
    // === GeneralProsperity - Rich, warm gold expanding burst ===
