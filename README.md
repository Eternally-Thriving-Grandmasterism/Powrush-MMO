...
**Floor:** stranger/play floor `2163551`; `playable-preview` tag @ walked SHA `11c577e` (steward preview yes; not the glow commit; later tip `3fc46c9` is welcome-back breath only — comfort, not a second launch); Online grey; comfort + canons live; not a launch candidate.
