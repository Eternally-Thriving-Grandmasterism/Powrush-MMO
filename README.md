...
**Version:** workspace `21.88.0` (Cargo.toml). Lived-hour design tick `23.2.43` — not a Cargo bump. See `CHANGELOG.md` and `docs/WORK_PACK_NATIVE.md`. Historical launch docs: `docs/archive/README.md`. README wins conflicts.
