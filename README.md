...
WASD walk · Space jump · Shift sprint · **E** harvest / tend (glow, camera punch, first-take rumble) · **I** satchel · **H** hide guidance · **R** allocate (**1** flow · **2** reserve). Peace: W is silent 0. **Tab / G / L / Q** stay dead until Charter + Frontier. Peace visitor on Frontier: E is *Not your charter*. Frontier **Q**: House tutorial until a crate arrives. **G** Voice: E aye on the beacon card.
