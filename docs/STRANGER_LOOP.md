...
Stand-alone proof script. Match L1 title truth + playable loop. Deeper maps: `LAUNCH_UX` · `INPUT_CANON` · `PLACES_BIBLE` · `PHASE_PLAYABLE_LOOP` · `HOUR_TWO` · `HOUR_THREE` · `PHASE_Q`/`R`/`S` · `PHASE_LETHAL` · `PREVIEW_CHECKLIST`.
